...
Esta ferramenta usa como ficheiro de entrada um vector no "Datum 73 Militar" (ESRI:102160). O ficheiro de saída será um shapefile no Sistema de Referência PT-TM06/ETRS89 (EPSG:3763).
