...
Esta ferramenta usa como ficheiro de entrada um vector no "Datum Lisboa" (ESRI:102165 / EPSG:20791 / EPSG:5018). O ficheiro de saída será um shapefile no Sistema de Referência PT-TM06/ETRS89 (EPSG:3763).
