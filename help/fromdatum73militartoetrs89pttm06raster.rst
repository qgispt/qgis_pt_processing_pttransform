...
The tool take an input raster defined with the "Datum 73 Militar" CRS (ESRI 102160) and creates an output geotiff defined with the ETRS89-PTTM06 CRS (EPSG 3763).
