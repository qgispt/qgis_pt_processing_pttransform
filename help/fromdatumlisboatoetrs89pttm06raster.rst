...
The tool takes an input raster layer defined with the "Datum Lisboa" CRS (ESRI 102165 or EPSG 20791) and creates an output geotiff defined with the ETRS89-PTTM06 CRS (EPSG 3763).
